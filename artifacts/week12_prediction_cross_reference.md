...
| Citation traceable but authority-consistency fails | 19/30 cases; example `1997_792`. These citations are traceable, but the expected authority was not selected. |
