...
- [x] Complete the one permitted salient-term query correction on the same nine dev cases. (TF-IDF full-facts extraction improved 0/9 to 3/9 at k=100 and 4/9 at k=500, below the majority threshold; original frozen query construction retained and the round-two investigation closed.)
